Shader "CustomSprites/SpriteOutline"
{
	Properties
	{
		...
		_Glow("Sprite Glow Intensity", Range(0,50)) = 0
		_Glow2("Outline Glow Intensity", Range(0,50)) = 0
	}
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				result *= (1-c.a);
				result *= _Alpha2;
				float4 outline = result * _ColorOutline * _Glow2;
